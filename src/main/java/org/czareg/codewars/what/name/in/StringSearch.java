...
public class StringSearch {
    ...
    public static boolean nameInStr(@NonNull String str, @NonNull String name) {
        int indexOfLastLetter = 0;
        for (char letter : name.toCharArray()) {
            int letterFoundAtIndex = str.indexOf(letter, indexOfLastLetter);
            if (letterFoundAtIndex == -1) {
                return false;
            }
            indexOfLastLetter = letterFoundAtIndex + 1;
        }
        return true;
    }
}
